...
echo "start running task [$current/$count] ..."
yes Y | apk add musl-dev
echo "task [$current/$count] completed."
current=$((current+1))

echo "start running task [$current/$count] ..."
yes Y | apk add openssh
echo "task [$current/$count] completed."
current=$((current+1))
...
echo "start running task [$current/$count] ..."
tar -zcvf gcda-data-03.tar.gz linux/
echo "task [$current/$count] completed."
current=$((current+1))
...
echo "start running task [$current/$count] ..."
scp gcda-data-03.tar.gz detectivelyw@10.18.171.176:~/Downloads/
echo "task [$current/$count] completed."
current=$((current+1))
